...
const hostname: string = env.VITE_HOSTNAME || 'https://fam007e.github.io';
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: 'github',
        link: 'https://github.com/fam007e/extensions-source',
        ariaLabel: 'Project GitHub',
      },
    ],
    
    editLink: {
      pattern: 'https://github.com/fam007e/extensions-source/edit/website/website/:path',
